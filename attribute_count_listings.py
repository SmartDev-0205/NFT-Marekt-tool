...
def attribte_count_listings_def(params):
    result_str = ""
    file_name = "attribute_count_listings.py"
    ...
    print("=================================================================")
    result_str += "=================================================================\n"
    result_str += f"{sys.argv[1]} {attr_count} attribute listings on MagicEden\n"

    for k in sorted(floor, key=lambda k: floor[k]):
        result_str += f"    -({floor[k]} SOL) https://magiceden.io/item-details/{k}\n"
    result_str += "=================================================================\n"
